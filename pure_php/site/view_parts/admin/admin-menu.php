        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="admin.php?action=params">Params</a></li>
                    <li><a href="admin.php?action=gifts">Items List</a></li>
                    <li><a href="admin.php?action=winnings">Winnings</a></li>
                    <li>
                        <a href="#" data-toggle="dropdown"><span
                                    class="glyphicon glyphicon-user"></span> <?= App::$user->username ?> <span
                                    class="caret"></span></a>
